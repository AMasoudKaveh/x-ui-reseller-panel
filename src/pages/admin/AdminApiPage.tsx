...
const scopeLabels: Record<string, string> = {
  "profile:read": "View administrator profile",
  "representatives:read": "View representatives and usage",
  "representatives:create": "Create representatives",
  "representatives:update": "Modify representatives",
  "inbounds:read": "View all inbounds"
};
